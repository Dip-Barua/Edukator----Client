                ...
                <div className="card bg-base-100 w-8/12 p-6 rounded-2xl shadow-lg mx-auto">
                    ...
                    <img src={instructor} alt="" className='w-8/12 ' />
                        ...
                        <div className='w-6/12 flex flex-col justify-center items-center gap-8'>
                            ...
                            <button className="p-2 rounded-xl hover:bg-transparent hover:border-gray-800 hover:border-2 hover:text-black bg-orange-400 text-white text-lg w-4s/12 ">Start Teaching Today</button>
                            </div>
                    </div>
