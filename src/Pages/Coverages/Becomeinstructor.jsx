    ...
    return (
        <div>
            <div className='my-20'>
                ...
                <div className="card bg-base-100 w-10/12 sm:w-8/12 p-6 rounded-2xl shadow-lg mx-auto">
                    <div className="flex flex-col sm:flex-row">
                    <div className=' sm:w-6/12 flex justify-center'>
                    <img src={instructor} alt="" className='w-8/12 ' />
                        </div>
                        <div className='w-full sm:w-6/12 flex flex-row sm:flex-col justify-center items-center gap-8'>
                            <div className='flex flex-col gap-5'>
                                 <h3 className="text-xl sm:text-4xl text-center font-bold">Instructing is Fun, Not Boring!</h3>
                            ...
                            <button className="p-2 rounded-xl hover:bg-transparent hover:border-gray-800 hover:border-2 hover:text-black bg-orange-400 text-white text-lg w-6/12 sm:w-4/12 mx-auto "><Link to="/teach">Start Teaching</Link></button>
